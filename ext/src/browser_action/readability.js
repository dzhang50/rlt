...
helpers.setCleanRules = function(rules) {
  cleanRules = rules;
};
 ...
 * @return void
 **/
var prepDocument = helpers.prepDocument = function(document) {
 ...
 * @return Element
 **/
var grabArticle = helpers.grabArticle = function(document, preserveUnlikelyCandidates) {
  /**
 ...
 * @return string
 **/
getInnerText = helpers.getInnerText = function(e, normalizeSpaces) {
  var textContent = "";
...
function Readability(documentText, options) {
  var doc = document.implementation.createHTMLDocument('');
  body = documentText//.replace(/.*<body/, '<body');
